...
{
    public RunningState(PlayerMovementStateManager context, PlayerMovementStateFactory factory) : base(context, factory)
    {
    }
    ...
    public override void CheckSwitchState()
    {
        ...
        else if (CTX.CurrentMovement.magnitude > 0f && !CTX.IsRunPressed) SwitchState(Factory.Walking());
    }
